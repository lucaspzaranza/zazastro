  ...
  return (
    <div className="w-full flex flex-col items-center justify-between gap-2">
      <div className="w-full flex flex-row justify-between gap-2">
        <select
          className="default-input-field text-sm bg-white"
          onChange={(e) => {
        ...
        {customACMode === 0 && (
          <form className="w-full flex flex-row gap-2 text-sm"
            ...
            <div className="w-full flex flex-row gap-2">
              <select
                value={signIndex}
                className="default-input-field w-full bg-white"
                onChange={(e) => {
              ...
              <input
                ref={ascInputRef}
                className="default-input-field w-[5rem] md:w-[8rem] p-1 text-sm bg-white"
